...
/*
 * RIL customization for Samsung ja devices
 */

public class jaRIL extends RIL {
    ...
    public jaRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
        mQANElements = 6;
    }

    public jaRIL(Context context, int preferredNetworkType,
    ...
    public void sendSMSExpectMore(String smscPDU, String pdu, Message result) {
        Rlog.v(RILJ_LOG_TAG, "jaRIL: sendSMSExpectMore");
